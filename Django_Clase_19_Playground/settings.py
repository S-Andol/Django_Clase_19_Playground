"""
Django settings for Django_Clase_19_Playground project.
...
ROOT_URLCONF = 'Django_Clase_19_Playground.urls'
...
WSGI_APPLICATION = 'Django_Clase_19_Playground.wsgi.application'
